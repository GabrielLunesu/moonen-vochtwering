        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-lg font-bold">Donato Lunesu</span>
            </div>
            <p className="text-gray-400 mb-4">
              Uw erkende installateur voor warmtepompen en airconditioning in heel Nederland. Met meer dan 30 jaar ervaring en bijna 3000 tevreden klanten.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#werkgebied" className="text-gray-400 hover:text-white transition-colors">
                  Werkgebied
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <Link href="tel:+31612345678" className="text-gray-400 hover:text-white transition-colors">
                  +31 6 12345678
                </Link>
              </li>
              <li className="flex items-start">
                ...
                <Link href="mailto:info@donatolunesu.nl" className="text-gray-400 hover:text-white transition-colors">
